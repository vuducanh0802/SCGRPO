...
### DRA-GRPO
```
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 ACCELERATE_LOG_LEVEL=info accelerate launch  --config_file recipes/accelerate_configs/zero2.yaml   --num_processes=4   src/open_r1/grpo.py --config recipes/dra_grpo.yaml 
